...
// Busca recarrega o grid de produtos
...
function atualizaGrid()
{
    ...
    // mostra mensagem de careegamento
    ...
    // busca se a insert de palavra de filtro
    filtro = "";
    if ($("#filtrar").val())
        filtro = "/" + $("#filtrar").val();

    // obter dados do server com ajax
    // get classe produtos e metodo listaAll
    $.ajax({
        type: "get",
        ...
        success: function(data) 
        {
            ...
            data.result.forEach(function(produto) 
            {
                row = "<tr>"
                        ...
                        + "</td><td> <a href='#'><i class='icon-remove' data-id='" 
                        + produto.id 
                        + "' data-nome='" 
                        + produto.nome 
                        + "'/></i></a>"
...
$('#salvar').click(function() 
{
    ...
    if (valido)
    {
        ...
        // POST, classe Produto, metodo save
        $.ajax({
            type: "post",
    ...
    $.ajax({
        ...
        success: function(data) 
        {
            ...
            data.result.forEach(function(categoria) 
            {
                ...
                selectFornecedor.append('<option value="' 
                    + categoria.id 
                    + '">' 
                    + categoria.nome 
                    + '</option>');
                ...
                + "' data-nome='" 
                + categoria.nome 
                + "' class='categoriaEdit'><span class='badge badge-success'>" 
                + categoria.nome 
                + "</span></a>";
