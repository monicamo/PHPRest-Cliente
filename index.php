...
/**
 * Sistema em jQuery. O PHP é usado apenas como template das páginas
...
// verifica se a variavel 'go' esta criada
// e se existe o arquivo que deve ser carregado
// qq outra situacao, ira para login.html
if (isset($_GET["go"])) 
{
...
<html>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container" style="width:auto">
                    ...
                    <a class="brand" href="#">Estadão Conteúdo Dados</a>
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            // criada de acordo com o COOKIE do login
                            $mensagemUsuario = "";

                            $usuario = null;

                            //Obtém o cookie da pessoa logada (informacoes)
                            ...
                            /*
                            	Metodo getActive eh usado para que possamos selecionar
                            	as paginas que o usuario esta, em que item ele esta
                             */
                            if (isset($usuario)) 
                            {
                            	// TIPO admin
        ...
        <!-- Contem funcoes e configuraçoes do projeto -->
